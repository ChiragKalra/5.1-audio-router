...
OutputDeviceNode.prototype.onDrawForeground = function(ctx) {
    ...
    // L channel meter
    ctx.fillText("Out L", 10, startY + 6);
    ctx.fillStyle = "#2d5";
    ctx.fillRect(50, startY, this.levels[0] * meterWidth, 10);
    ctx.strokeStyle = "#444";
    ctx.strokeRect(50, startY, meterWidth, 10);
    
    // R channel meter
    ctx.fillStyle = "#fff";
    ctx.fillText("Out R", 10, startY + 26);
    ctx.fillStyle = "#2d5";
    ctx.fillRect(50, startY + 20, this.levels[1] * meterWidth, 10);
    ctx.strokeStyle = "#444";
    ctx.strokeRect(50, startY + 20, meterWidth, 10);
    ...
    ctx.fillStyle = "#888";
    ctx.font = "10px Arial";
    ctx.fillText(`L: ${lCount} mixed | R: ${rCount} mixed`, 10, startY + 45);
};
